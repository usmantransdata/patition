...
<body class="no-skin">
          <div class="main-container" id="main-container">
            <script type="text/javascript">
                      ...
                      New Template
                    	...
                    	<div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="summernote form-control" id="textarea" name="template"></textarea>
                            </div>
             ...
             <button  style="margin-top: 20px; margin-left: 300px;height:50px;width: 600px;color:red;" id="start_button" 	class="btn btn-success" type="submit" value="Creat Email Template">template must be above then 50 words</button>
                            </div>
                        </form>
                </div>
            </div>
