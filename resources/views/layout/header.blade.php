    ...
    <div id="navbar" class="navbar navbar-default">
      ...
      <div class="navbar-container" id="navbar-container">
        ...
        <div class="navbar-header pull-left">
          ...
          <a href="/vop/index.php/backend" class="navbar-brand">
            <small>
              ...
              <ul class="nav ace-nav" >
                ...
                <li class="light-blue">
                   <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="background-color: transparent;">
                      <img src="{{ asset('/') }}public/dist/img/user.png" style="width: 30px;" class="user-image" alt="User Image">
                      <span class="hidden-xs">{{ Auth::user()-> name }}</span>
                    </a>

                  <ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                     <li class="user-header">
                     <img src="{{ asset('/') }}public/dist/img/user.png" style="width: 150px;" class="user-image" alt="User Image">
