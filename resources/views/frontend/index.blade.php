...
<div class="container">
  <div class="row">
    <!--Card-blog 1 -->
    <div class="col m12">
       @foreach($petitions->slice(0, 1) as $key => $petition)
     
      <div class="card horizontal hide-on-med-and-down hoverable">
        <div class="card-image"> 
          <img src="{{asset('/')}}storage/app/{{$petition->avatar}}"  style="opacity: 0.6;">
          <div class="text-block" style="position: absolute;bottom: 283px;">
            <i class="material-icons medium red-text">bookmark</i>
          </div>
          <div class="card-title" style="background-color: #263238 ; width: 100%;">{{$petition->title}}</div>
        </div>
        <div class="card-content">
          <a href=""><span class="card-title black-text">{{$petition->title}} </span></a>
          <p>{{$petition->description}}</p><a href="{{route('petition.show', $petition->id)}}" class="red-text">View Article</a>
          <p>
         ...
         <!--   <div class="col s12 m12">
            ...
            <div class="card horizontal">
              ...
              <div class="card-stacked">
                <div class="card-content">
                  <p style="font-size: 20px">{{substr($petition->message, 0, 275)}}</p>
                </div>
