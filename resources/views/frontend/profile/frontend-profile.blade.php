...
<section>
  <div class="container">
    ...
    <div class="col s12">
      <ul class="tabs green lighten-2">
        ...
        <li class="tab col s3"><a href="#test3" class="black-text">Signed Petitoin</a></li>
        <li class="tab col s3">
         ...
         <div class="card horizontal hoverable" style="height: 200px;">
                ...
                <div class="card-stacked">
                  <div class="card-content"> <a href="{{route('petition.show', $petition->id)}}" class="green-text">
                    ...
                    <p style="height: 40px">{{substr($petition->message, 0, 200)}}</p>
                    <br>
                    <br>
      ...
      @if($pet->survey->first()['petition_id'] !=  $pet->id)
        ...
        @else
         <tr class="td">
            ...
            <td><a href="#"> {{count($pet->surveyResult->first()['survey_id'])}}</a></td>
  ...
  <center><strong class="green-text"><h3>Signed Petition</h3></strong></center>
   <table id="table" class="display">
              ...
              <tbody>
                @if(!empty($sign))
                @foreach($sign as $pet_sign)
              <tr class="td">
                      <td style="padding: 24px 16px;font-size: 13px;border-bottom: 2px solid #f4f5f5;"><a href="#">{{$pet_sign->title}}</a></td>
                      <td>{{ \Carbon\Carbon::parse($pet_sign->created_at)->format('d/m/Y')}}</td>
                     
                    <td><a href="#">{{count($pet_sign->signPetition->first()['answer'])}}</a></td>
